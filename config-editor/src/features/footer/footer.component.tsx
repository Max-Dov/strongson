...
const contractsLink = <a tabIndex={1} href="https://github.com/Max-Dov/strongson/blob/main/notes/contracts.md">Contracts</a>

const githubSvg = <svg width="1em" height="1em" strokeWidth="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
...
export const Footer = () => (
    <footer>
        <ul>
            <li>Supported {contractsLink} version: v5.</li>
            <li><a tabIndex={1} href="https://github.com/Max-Dov/strongson">{githubSvg} Strongson</a></li>
            <li><a tabIndex={1} href="https://github.com/Max-Dov/strongson/tree/main/config-editor">{githubSvg} Strongson Config Editor</a></li>
        </ul>
    </footer>
);